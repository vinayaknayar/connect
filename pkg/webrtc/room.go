...
func RoomConn(c *websocket.Conn, p *Peers) {
	...
	// Add our media track to the PeerConnection so our friend can receive it. This returns a *webrtc.RTPSender so we can stop it later if we want to mute our video. It is not required to do this if you are sending only audio or vice versa 
